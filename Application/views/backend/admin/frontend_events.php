							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default pull-right" role="menu">
											<!-- EDITING LINK -->
											<li>
													<a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/frontend_events_edit/'.$row['frontend_events_id']);?>');">
												...
												<!-- DELETION LINK -->
												<li>
													<a href="#" onclick="confirm_modal('<?php echo site_url('admin/frontend_events/delete/'.$row['frontend_events_id']);?>');">
