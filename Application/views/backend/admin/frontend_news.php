							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default pull-right" role="menu">
												<!-- EDITING LINK -->
												<li>
														<a href="<?php echo site_url('admin/frontend_pages/news_edit/'.$row['frontend_news_id']);?>">
												...
												<!-- DELETION LINK -->
												<li>
													<a href="#" onclick="confirm_modal('<?php echo site_url('admin/frontend_news/delete/'.$row['frontend_news_id']);?>');">
