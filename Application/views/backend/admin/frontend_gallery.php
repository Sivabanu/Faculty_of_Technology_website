...
<div class="tab-content">
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default pull-right" role="menu">
										<li>
												<a href="<?php echo site_url('admin/frontend_pages/gallery_image/'.$row['frontend_gallery_id']);?>">
										...
										<li class="divider"></li>
											<!-- EDITING LINK -->
											<li>
													<a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/frontend_gallery_edit/'.$row['frontend_gallery_id']);?>');">
    ...
    <form class="form-horizontal form-groups" method="post"
			action="<?php echo site_url('admin/frontend_gallery/add_gallery');?>"
